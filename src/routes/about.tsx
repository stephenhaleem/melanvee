...
const values = [
  ...
  {
    n: "03",
    t: "Made to Feel Like Yours",
    d: "Soft enough to live in. Natural enough that no one has to know it isn't your own.",
  },
];
    ...
    <Layout>
      <section className="py-24 md:py-32 text-center">
        ...
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-cream leading-[1] max-w-4xl mx-auto px-6">
          Made for <em className="italic text-gradient-blush">our textures</em>
        </h1>
      ...
      <section className="py-28 md:py-40">
        <div className="max-w-3xl mx-auto px-6 lg:px-12 space-y-10 text-lg text-mauve leading-loose">
          ...
          <p>
            MELANVÉE exists for every woman who is tired of salons, tired of wearing wigs that look
      ...
      <section className="py-24 bg-charcoal">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl text-cream text-center leading-tight">
            What we <em className="italic text-gradient-blush">stand for</em>.
          </h2>
