...
export const products: Product[] = [
  ...
  },
  {
    ...
    type: "U-Part Wig",
    texture: "3A",
    tagline: "Loose spirals with shine",
    shortDescription:
    ...
    longDescription:
      "Beach Curl is our 3A curl piece. Big, open spirals with natural shine and movement. Low shrinkage with a curl pattern that falls freely. Light, bouncy and soft. Built as a U-part so you can pull your own hair through and blend seamlessly, she gives you full wig fullness with slip-on ease. The piece you reach for when you want to feel a little more put together without overthinking it.",
    blendsWith: ["Short hair", "Long hair", "Relaxed hair", "Natural hair"],
    startingPriceGBP: 155,
    image: product3,
    notes: ["U-Part", "3A Match", "No Lace", "No Glue"],
    features: commonFeatures,
    density: commonDensity,
    lifespan: "1 to 3 years with proper care",
    other: commonOther,
  ...
  },
  {
    ...
    type: "U-Part Wig",
    texture: "3B to 3C",
    tagline: "Defined spirals with volume",
    shortDescription:
      "Springy, tighter spirals with strong definition and volume. Denser curl pattern that holds its shape with real bounce and texture.",
    longDescription:
      "Coco Curl is our 3B to 3C curl piece. Springy, tighter spirals with strong definition and volume. Denser curl pattern that holds its shape with real bounce and texture. Built as a U-part so you can pull your own hair through and blend seamlessly, she gives you full wig fullness with slip-on ease. The piece you reach for when you want defined, bouncy curls that hold their shape all day.",
    blendsWith: ["Short hair", "Long hair", "Relaxed hair", "Natural hair"],
    startingPriceGBP: 155,
    image: product3,
    notes: ["U-Part", "3B to 3C Match", "No Lace", "No Glue"],
    features: commonFeatures,
    density: commonDensity,
    lifespan: "1 to 3 years with proper care",
    other: commonOther,
