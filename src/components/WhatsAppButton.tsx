...
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hi MELANVÉE, I'd love to know more about your wigs."
);
...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-3 bg-[#25D366] text-white px-5 py-3 rounded-full shadow-luxe hover:scale-105 transition-transform duration-300"
    >
