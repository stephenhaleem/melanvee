...
export function Footer() {
  return (
    <footer className="border-t border-border mt-32 bg-cream">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-sm text-mauve max-w-sm leading-relaxed">
            Half wigs and U-part wigs for women of colour — true to your kinks,
            coils, and curls.
          </p>
          ...
          <div className="mt-6 flex items-center gap-4">
            <a
              ...
              className="w-10 h-10 inline-flex items-center justify-center border border-border text-noir hover:text-gold hover:border-gold transition-colors"
            >
